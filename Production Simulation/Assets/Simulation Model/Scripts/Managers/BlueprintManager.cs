...
public class BlueprintManager : MonoBehaviour
{
    ...
    /// <summary>
    /// Setup component, set allowed resource, internal buffer size etc.
    /// </summary>
    ...
    /// <summary>
    /// Update the blueprints, allowed resources and buffer size based on a new input state
    /// </summary>
    /// <param name="currentInputBuffer"></param>
    ...
    /// <summary>
    /// Checker to scan for completable blueprints
    /// </summary>
    /// <param name="currentInputBuffer"></param>
    /// <returns></returns>
